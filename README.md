...
Live at → [jido6777.github.io](https://jido6777.github.io)
...
### 01 — Night City Portfolio
The site you're looking at. Built with pure HTML, CSS and vanilla JS — no build step, no frameworks, no dependencies.

### 02 — Estrada Brokers SAS
Corporate website for a Colombian insurance broker firm. Clean, professional layout with responsive design, custom sections and smooth UX — built from scratch.
→ [estradabrokerssas.com](https://estradabrokerssas.com)
...
**Also working with**
`React` `TypeScript` `Tailwind` `Next.js` `GSAP` `Vite` `Figma`
...
```bash
git clone https://github.com/jido6777/jido6777.github.io.git
cd jido6777.github.io
